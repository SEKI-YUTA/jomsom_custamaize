				...
				<section id="featured-content" class="' . $classes . '">
					<div class="container">';
						if ( !empty( $headline ) || !empty( $subheadline ) ) {
							$jomsom_featured_content .='<div class="featured-heading-wrap">';
								...
								if ( !empty( $subheadline ) ) {
									$jomsom_featured_content .='<p>' . wp_kses_post( $subheadline ) . '</p>';
								}
						...
						<div class="featured-content-wrap">';
							...
							// Select content
							if ( 'demo-featured-content' == $contentselect   && function_exists( 'jomsom_demo_content' ) ) {
								$jomsom_featured_content .= jomsom_demo_content( $options );
							}
							elseif ( 'featured-page-content' == $contentselect  && function_exists( 'jomsom_page_content' ) ) {
...
function jomsom_demo_content( $options ) {
	...
	$jomsom_demo_content = '
		<div class="featured_content_slider_wrap">
			<article id="featured-post-1" class="post hentry post-demo">
				<figure class="featured-content-image">
					<img alt="Aurora borealis" class="wp-post-image" src="'.trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'images/gallery/featured5-350x350.jpg" />
				</figure>
			...
			<article id="featured-post-2" class="post hentry post-demo">
				<figure class="featured-content-image">
					<img alt="Zenit Camera" class="wp-post-image" src="'.trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'images/gallery/featured6-350x350.jpg" />
				</figure>
				<div class="entry-container">
					<header class="entry-header">
						<h1 class="entry-title">
			...
			<article id="featured-post-3" class="post hentry post-demo">
				<figure class="featured-content-image">
					<img alt="Domestic Cat" class="wp-post-image" src="'.trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'images/gallery/featured7-350x350.jpg" />
				</figure>
				<div class="entry-container">
					<header class="entry-header">
						<h1 class="entry-title">
		...
		if( 'layout-four' == $options['featured_content_layout']) {
			...
			<article id="featured-post-4" class="post hentry post-demo">
				<figure class="featured-content-image">
					<img alt="Northern lights" class="wp-post-image" src="'.trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'images/gallery/featured8-350x350.jpg" />
				</figure>
				<div class="entry-container">
					<header class="entry-header">
						<h1 class="entry-title">
	...
	if ( $sliderselect ) {
		...
		<div class="featured_content_slider_wrap">
			<article id="featured-post-1" class="post hentry post-demo">
				<figure class="featured-content-image">
					<img alt="Cherry Blossom" class="wp-post-image" src="'.trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'images/gallery/featured1-350x350.jpg" />
				</figure>
				<div class="entry-container">
					<header class="entry-header">
						<h1 class="entry-title">
			...
			<article id="featured-post-2" class="post hentry post-demo">
				<figure class="featured-content-image">
					<img alt="Alpsee" class="wp-post-image" src="'.trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'images/gallery/featured2-350x350.jpg" />
				</figure>
				<div class="entry-container">
					<header class="entry-header">
						<h1 class="entry-title">
			...
			<article id="featured-post-3" class="post hentry post-demo">
				<figure class="featured-content-image">
					<img alt="Gautama Buddha" class="wp-post-image" src="'.trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'images/gallery/featured3-350x350.jpg" />
				</figure>
				<div class="entry-container">
					<header class="entry-header">
						<h1 class="entry-title">
		...
		if( 'layout-four' == $options['featured_content_layout']) {
			...
			<article id="featured-post-4" class="post hentry post-demo">
				<figure class="featured-content-image">
					<img alt="Clover Plant" class="wp-post-image" src="'.trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'images/gallery/featured4-350x350.jpg" />
				</figure>
				<div class="entry-container">
					<header class="entry-header">
						<h1 class="entry-title">
			...
			$jomsom_page_content .= '
				...
				if ( has_post_thumbnail() ) {
					...
					<figure class="featured-content-image">
						...
						'. get_the_post_thumbnail( $post->ID, $thumbnail_size, array( 'title' => $title_attribute, 'alt' => $title_attribute, 'class' => 'pngfix ' . $thumbnail_size ) ) .'
						</a>
					</figure>';
				}
				else {
					//Default value if there is no first image
					$jomsom_image = '<img class="pngfix wp-post-image" src="'.esc_url( get_template_directory_uri() ).'/images/gallery/no-featured-image-1680x720.jpg" >';

					//Get the first image in page, returns false if there is no image
					$jomsom_first_image = jomsom_get_first_image( $post->ID, $thumbnail_size, array( 'title' => $title_attribute, 'alt' => $title_attribute, 'class' => 'pngfix ' . $thumbnail_size ) );
				...
				if ( '1' == $options['featured_content_enable_title'] || '1' == $options['featured_content_enable_date'] || '0'!= $options['featured_content_enable_excerpt_content'] ) {
					...
					elseif ( '2' == $options['featured_content_enable_excerpt_content'] ) {
						...
						$jomsom_page_content .= '<div class="entry-content">' .wp_kses_post( $content ) . '</div><!-- .entry-content -->';
					}
				}
				$jomsom_page_content .= '
