	...
	public function render_content() {
		$dropdown = wp_dropdown_categories(
			array(
				...
				'hide_if_empty'    => false,
				'show_option_all'  => esc_html__( 'All Categories', 'jomsom' )
			)
		);
    ...
    public function render_content() {
        ...
        $important_links = array(
						'theme_instructions' => array(
							'link'	=> esc_url( 'https://catchthemes.com/theme-instructions/jomsom/' ),
						...
						'changelog' => array(
							'link'	=> esc_url( 'https://catchthemes.com/changelogs/jomsom-theme/' ),
