				...
				<section id="feature-slider">
					<div class="container">
						<div class="cycle-slideshow"
							...
							// Select Slider
							if ( 'demo-featured-slider' == $sliderselect  && function_exists( 'jomsom_demo_slider' ) ) {
								$jomsom_featured_slider .=  jomsom_demo_slider( $options );
							}
							elseif ( 'featured-page-slider' == $sliderselect  && function_exists( 'jomsom_page_slider' ) ) {
			...
			<article class="'.$classes.'">
				...
				if ( has_post_thumbnail() ) {
					$jomsom_page_slider .= '<a title="' . the_title_attribute( array( 'before' => __( 'Permalink to:', 'jomsom' ), 'echo' => false ) ) . '" href="' . esc_url( get_permalink() ) . '">
						'. get_the_post_thumbnail( $post->ID, 'jomsom_slider', array( 'title' => $title_attribute, 'alt' => $title_attribute, 'class'	=> 'pngfix' ) ).'
					</a>';
				}
				else {
					...
					$jomsom_first_image = jomsom_get_first_image( $post->ID, 'jomsom-slider', array( 'title' => $title_attribute, 'alt' => $title_attribute, 'class' => 'pngfix' ) );
