...
function jomsom_layouts() {
	$layout_options = array(
		'left-sidebar'  => __( 'Primary Sidebar, Content', 'jomsom' ),
		'right-sidebar' => __( 'Content, Primary Sidebar', 'jomsom' ),
		'no-sidebar'    => __( 'No Sidebar ( Content Width )', 'jomsom' ),
	);
...
function jomsom_get_archive_content_layout() {
	$layout_options = array(
		'excerpt-image-left' => __( 'Excerpt Image Left', 'jomsom' ),
		'full-content'       => __( 'Show Full Content (No Featured Image)', 'jomsom' ),
	);
...
function jomsom_enable_featured_header_image_options() {
	$enable_featured_header_image_options = array(
		'homepage'               => __( 'Homepage / Frontpage', 'jomsom' ),
		'exclude-home'           => __( 'Excluding Homepage', 'jomsom' ),
		'exclude-home-page-post' => __( 'Excluding Homepage, Page/Post Featured Image', 'jomsom' ),
		'entire-site'            => __( 'Entire Site', 'jomsom' ),
		'entire-site-page-post'  => __( 'Entire Site, Page/Post Featured Image', 'jomsom' ),
		'pages-posts'            => __( 'Pages and Posts', 'jomsom' ),
		'disabled'               => __( 'Disabled', 'jomsom' ),
	);
...
function jomsom_featured_image_size_options() {
	$featured_image_size_options = array(
		'full'   => __( 'Full Image', 'jomsom' ),
		'large'  => __( 'Large Image', 'jomsom' ),
		'slider' => __( 'Slider Image', 'jomsom' ),
	);
...
function jomsom_featured_content_types() {
	$featured_content_types = array(
		'demo-featured-content' => __( 'Demo', 'jomsom' ),
		'featured-page-content' => __( 'Page', 'jomsom' ),
	);
...
function jomsom_featured_content_layout_options() {
	$featured_content_layout_option = array(
		'layout-three' => __( '3 columns', 'jomsom' ),
		'layout-four'  => __( '4 columns', 'jomsom' ),
	);
...
function jomsom_featured_content_show() {
	$featured_content_show_option = array(
		'1' => __( 'Show Excerpt', 'jomsom' ),
		'2' => __( 'Show Full Content', 'jomsom' ),
		'0' => __( 'Hide Content', 'jomsom' ),
	);
...
function jomsom_featured_slider_types() {
	$featured_slider_types = array(
		'demo-featured-slider' => __( 'Demo', 'jomsom' ),
		'featured-page-slider' => __( 'Page', 'jomsom' ),
	);
...
function jomsom_featured_slide_transition_effects() {
	$featured_slide_transition_effects = array(
		'fade' 		=> __( 'Fade', 'jomsom' ),
		'fadeout' 	=> __( 'Fade Out', 'jomsom' ),
		'none' 		=> __( 'None', 'jomsom' ),
		'scrollHorz'=> __( 'Scroll Horizontal', 'jomsom' ),
		'scrollVert'=> __( 'Scroll Vertical', 'jomsom' ),
		'flipHorz'	=> __( 'Flip Horizontal', 'jomsom' ),
		'flipVert'	=> __( 'Flip Vertical', 'jomsom' ),
		'tileSlide'	=> __( 'Tile Slide', 'jomsom' ),
		'tileBlind'	=> __( 'Tile Blind', 'jomsom' ),
		'shuffle'	=> __( 'Shuffle', 'jomsom' ),
	);
...
function jomsom_get_pagination_types() {
	$pagination_types = array(
		'default'                => __( 'Default(Older Posts/Newer Posts)', 'jomsom' ),
		'numeric'                => __( 'Numeric', 'jomsom' ),
		'infinite-scroll-click'  => __( 'Infinite Scroll (Click)', 'jomsom' ),
		'infinite-scroll-scroll' => __( 'Infinite Scroll (Scroll)', 'jomsom' ),
	);
...
function jomsom_single_post_image_layout_options() {
	$single_post_image_layout_options = array(
		'large'             => __( 'Large', 'jomsom' ),
		'full-size'         => __( 'Full size', 'jomsom' ),
		'slider-image-size' => __( 'Slider Image Size', 'jomsom' ),
		'slider-image-size' => __( 'Featured Image Size', 'jomsom' ),
		'disabled'          => __( 'Disabled', 'jomsom' ),
	);
...
function jomsom_get_content() {
	...
	$jomsom_content['left'] 	= sprintf( _x( 'Copyright &copy; %1$s %2$s. All Rights Reserved.  %3$s', '1: Year, 2: Site Title with home URL 3: Privacy Policy Link', 'jomsom' ), esc_attr( date_i18n( __( 'Y', 'jomsom' ) ) ), '<a href="'. esc_url( home_url( '/' ) ) .'">'. esc_attr( get_bloginfo( 'name', 'display' ) ) . '</a>', get_the_privacy_policy_link() );
